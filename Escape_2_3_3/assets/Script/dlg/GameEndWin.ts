...
export default class GameEndWin extends cc.Component {
    ...
    m_AdCoin: cc.Label = null; //看广告能得到的金币
    m_BtnAds: cc.Node = null;//看广告的按钮
    m_Row: cc.Node = null;
    m_CoinFly: cc.Node = null;//飞行的金币
    m_SkinSlider: cc.Sprite = null;//白色遮罩
    m_SkinProgress: cc.Label = null;//皮肤解锁进度
    ...
    TempGetCount: number = 0;//获取到的金币
    m_CurMul: number = 0;//当前转到的倍数位置
